...
void RaytracingBasic::initWindow() {
	glfwInit();
...
void RaytracingBasic::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
	auto app = reinterpret_cast<RaytracingBasic*>(glfwGetWindowUserPointer(window));
	app->framebufferResized = true;
}

void RaytracingBasic::initVulkan() {
	createInstance();
	setupDebugMessenger();
	createSurface();
	pickPhysicalDevice();
...
void RaytracingBasic::createInstance() {
...
void RaytracingBasic::setupDebugMessenger() {
...
void RaytracingBasic::createSurface() {
	if (glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS) {
		throw std::runtime_error("failed to create window surface!");
	}
}

void RaytracingBasic::pickPhysicalDevice() {
...
void RaytracingBasic::createLogicalDevice() {
...
void RaytracingBasic::createSwapChain() {
...
VkImageView RaytracingBasic::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
void RaytracingBasic::createImageViews() {
...
void RaytracingBasic::createRenderPass() {
...
void RaytracingBasic::createDescriptorSetLayout() {
...
void RaytracingBasic::createGraphicsPipeline() {
	...
	// [FIXED] Pipeline layout indicates descriptorSetLayout.
...
void RaytracingBasic::createFramebuffers() {
...
void RaytracingBasic::createCommandPool() {
...
void RaytracingBasic::createDepthResources() {
...
VkFormat RaytracingBasic::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
...
VkFormat RaytracingBasic::findDepthFormat() {
...
bool RaytracingBasic::hasStencilComponent(VkFormat format) {
	return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
}

void RaytracingBasic::createTextureImage() {
...
void RaytracingBasic::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage,
...
void RaytracingBasic::createTextureImageView() {
	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT);
}

void RaytracingBasic::createTextureSampler() {
...
void RaytracingBasic::createVertexBuffer() {
...
void RaytracingBasic::createIndexBuffer() {
...
void RaytracingBasic::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void RaytracingBasic::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void RaytracingBasic::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkCommandBuffer RaytracingBasic::beginSingleTimeCommands() {
...
void RaytracingBasic::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void RaytracingBasic::createUniformBuffers() {
...
void RaytracingBasic::createDescriptorPool() {
...
void RaytracingBasic::createDescriptorSets() {
...
void RaytracingBasic::createCommandBuffer() {
...
void RaytracingBasic::createSyncObjects() {
...
void RaytracingBasic::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
	VkCommandBufferBeginInfo beginInfo{};
	beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
...
VkShaderModule RaytracingBasic::createShaderModule(const std::vector<char>& code) {
...
VkSurfaceFormatKHR RaytracingBasic::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR RaytracingBasic::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D RaytracingBasic::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
SwapChainSupportDetails RaytracingBasic::querySwapChainSupport(VkPhysicalDevice device) {
...
bool RaytracingBasic::isDeviceSuitable(VkPhysicalDevice device) {
...
bool RaytracingBasic::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices RaytracingBasic::findQueueFamilies(VkPhysicalDevice device) {
...
void RaytracingBasic::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
	createInfo = {};
...
// by Sehee 
bool RaytracingBasic::checkAllExtensionsIncluded(
	uint32_t extensionCount,
...
bool RaytracingBasic::checkValidationLayerSupport() {
	uint32_t layerCount;
...
std::vector<const char*> RaytracingBasic::getRequiredExtensions() {
...
VKAPI_ATTR VkBool32 VKAPI_CALL RaytracingBasic::debugCallback(
...
std::vector<char> RaytracingBasic::readFile(const std::string& filename) {
...
void RaytracingBasic::cleanupSwapChain() {
...
void RaytracingBasic::recreateSwapChain() {
...
uint32_t RaytracingBasic::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void RaytracingBasic::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer,
...
void RaytracingBasic::drawFrame() {
...
void RaytracingBasic::updateUniformBuffer(uint32_t currentImage) {
...
void RaytracingBasic::mainLoop() {	// iterate until window is closed.
